 ...
 */
export async function applyWorldMutations(
  campaignId: string,
  instructions: WorldMutationInstruction[],
): Promise<void> {
 ...
 */
export async function resolveQuestNode(
  resolution: NodeResolutionContext,
): Promise<QuestNodeResult> {
