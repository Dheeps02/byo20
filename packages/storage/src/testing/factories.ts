...
export function agendaEventFactory(
    campaignId: string,
    overrides: Partial<ReturnType<typeof agendaEventDefaults>> = {},
) {
...
export function worldObjectFactory(
    campaignId: string,
    overrides: Partial<ReturnType<typeof worldObjectDefaults>> = {},
) {
