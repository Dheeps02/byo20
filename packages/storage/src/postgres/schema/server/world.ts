...
export const faction_relationships = world.table(
    ...
    (t) => [unique("faction_relationships_pair_unique").on(t.faction_a_id, t.faction_b_id)],
);
 ...
 */
export const world_zones = world.table(
    "world_zones",
    {
        id: uuid("id").primaryKey().defaultRandom(),
        campaign_id: uuid("campaign_id")
    ...
    (t) => [unique("world_zones_campaign_hex_unique").on(t.campaign_id, t.hex_q, t.hex_r)],
);
