...
import { campaigns, character_campaign_state, character_classes, characters } from "../src/postgres/schema/server/game";
import { sessions } from "../src/postgres/schema/server/log";
import { factions, npcs, quests, world_zones } from "../src/postgres/schema/server/world";
    ...
    try {
        ...
        await db
            ...
            .values({
                ...
                premise:
                    "A long-forgotten citadel has risen from a coastal swamp. Locals report strange lights at night and missing livestock.",
        ...
        await db
            ...
            .values({
                ...
                description:
                    "A loose coalition of local militia and fishermen who keep watch over the coastal approach.",
        ...
        await db
            ...
            .values({
                ...
                nodes: [
                    {
                        id: "start",
                        objective: "Investigate the lights seen near the citadel at night",
                        edges: ["find-source"],
                        terminal: false,
                    },
                    {
                        id: "find-source",
                        objective: "Locate what is causing the disturbance",
                        edges: ["confront-threat"],
                        terminal: false,
                    },
                    {
                        id: "confront-threat",
                        objective: "Neutralize the threat by any means",
                        edges: ["report-back"],
                        terminal: false,
                    },
